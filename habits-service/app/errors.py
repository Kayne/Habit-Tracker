"""
Spójny format błędów — IDENTYCZNA struktura jak w auth-service.
Klient iOS dzięki temu ma jedną logikę obsługi błędów dla całego backendu.
"""
import logging
import uuid
...
logger = logging.getLogger("habits-service.errors")
...
def register_error_handlers(app: FastAPI) -> None:
    ...
    async def unhandled_handler(request: Request, exc: Exception):
        ...
        return JSONResponse(
            ...
            content=_envelope("INTERNAL_ERROR", "Internal server error", None, rid),
        )
